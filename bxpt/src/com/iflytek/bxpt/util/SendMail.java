package com.iflytek.bxpt.util;
	...
	public class SendMail {
		...
		public static String sendEmailAccount = "wzhou19971020@163.com";
		// 发件人的邮箱的授权码(自己在邮箱服务器中开启并设置)
		public static String sendEmailPassword = "ZW1997929";
		...
		public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail,
			...
			// 设置发件人姓名和编码格式
			message.setFrom(new InternetAddress(sendMail, "科大讯飞教育系统", "UTF-8"));
